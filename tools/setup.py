...
def main():
    ...
    print("""
  ######################################
  # 11RDP Development Environment Setup #
  ######################################

  This script will create your 11RDP dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your 11RDP project folder:
    [Arma 3 installation directory]\\{} => 11RDP project folder
    P:\\{}                              => 11RDP project folder
